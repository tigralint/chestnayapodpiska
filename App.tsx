...
export default function App() {
    ...
    return (
        <div className="relative z-0 min-h-[100dvh] overflow-x-hidden text-slate-100">
            {/* Static abstract ambient gradients — extracted to CSS for GPU layer reuse */}
            <div className="app-ambient-bg pointer-events-none fixed inset-0 -z-10 h-full w-full" aria-hidden="true" />
            ...
            <ErrorBoundary>
                <main
                    id="main"
                    className="relative z-10 mx-auto min-h-[100dvh] w-full max-w-6xl pb-28 pt-[max(1rem,env(safe-area-inset-top))] md:pb-24 md:pt-32"
                >
                    <div className="view-enter h-full w-full">
