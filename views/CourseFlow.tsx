                            ...
                            <label className="group mt-4 flex cursor-pointer items-start gap-3 px-1">
                                <div className="relative mt-0.5 flex items-center justify-center">
                                    <input
                                        ...
                                        className="peer h-5 w-5 cursor-pointer appearance-none rounded-md border-2 border-white/20 bg-white/5 outline-none transition-all checked:border-accent-purple checked:bg-accent-purple focus-visible:ring-2 focus-visible:ring-accent-purple/50 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
                                    />
                                    <svg
                                ...
                                <span className="text-xs font-medium leading-relaxed text-slate-400 transition-colors group-hover:text-slate-300">
                                    ...
                                    <Link
                                        to="/privacy"
                                        className="text-accent-purple transition-colors hover:underline"
