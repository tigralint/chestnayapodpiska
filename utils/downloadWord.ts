        ...
        sections: [
            {
                ...
                children: [
                    // --- RECIPIENT BLOCK (Шапка - левое выравнивание со смещением вправо) ---
                    new Paragraph({
                        alignment: AlignmentType.LEFT,
                        indent: { left: 5100 }, // Смещение вправо на ~9 см (5100 twips)
                        spacing: { after: 200 },
                        children: [
                    ...
                    // --- SENDER BLOCK (левое выравнивание со смещением вправо) ---
                    new Paragraph({
                        alignment: AlignmentType.LEFT,
                        indent: { left: 5100 }, // Смещение вправо на ~9 см
                        spacing: { after: 600 },
                        children: [new TextRun({ text: 'От: ', bold: true }), new TextRun({ text: senderInfo })],
                    }),
                    ...
                    new Paragraph({
                        ...
                        children: [new TextRun({ text: mainHeading, bold: true, size: 28 })],
                    }),
                    ...
                    ...(subHeading
                        ? [
                              new Paragraph({
                                  alignment: AlignmentType.CENTER,
                                  spacing: { after: 400 },
                                  children: [new TextRun({ text: subHeading, size: 24 })],
                              }),
                          ]
                        : []),
